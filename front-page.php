...
function monochrome_front_page_genesis_meta() {
   ...
   if ( is_active_sidebar( 'front-page-5' ) ) {
    wp_enqueue_script( 'particles', get_stylesheet_directory_uri() . '/js/particles.min.js', '', '2.0.0', true );

    wp_enqueue_script( 'particles-init', get_stylesheet_directory_uri() . '/js/particles-init.js', '', '1.0.0', true );
}
